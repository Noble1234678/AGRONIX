            ...
            <section id="about" className="section">
                ...
                <div className="container">
                    <div className="grid-2" style={{ alignItems: 'center', minHeight: '60vh' }}>
                        <div className="reveal" style={{ display: 'flex', flexDirection: 'column', width: '100%' }}>
                            <div style={{ alignSelf: 'flex-start' }}>
                                <span className="badge">Our Vision</span>
                            </div>
                            <h2 className="grad-text" style={{ margin: '1.5rem 0 1rem 0', fontSize: 'clamp(2rem, 5vw, 3rem)', textAlign: 'left' }}>Farming the Future</h2>
                            <p className="desc-lg" style={{ color: 'var(--text-dim)', marginBottom: '2.5rem', lineHeight: '1.8', fontSize: 'clamp(1rem, 2vw, 1.1rem)', textAlign: 'left' }}>
                            ...
                            <div style={{ display: 'flex', gap: '2.5rem', alignItems: 'center', flexWrap: 'wrap' }}>
                                <div style={{ textAlign: 'left' }}>
                                    <h4 style={{ color: 'var(--primary-green)', fontSize: 'clamp(2rem, 6vw, 2.5rem)', margin: 0, lineHeight: 1, fontWeight: 800 }}>200+</h4>
                                    <p style={{ color: 'var(--text-muted)', fontSize: '0.85rem', fontWeight: 700, margin: '0.5rem 0 0 0', letterSpacing: '1px' }}>EXPECTING PARTICIPANTS</p>
                                </div>
                                <div className="stat-divider" style={{ width: '2px', height: '50px', background: 'var(--glass-border)', opacity: 0.6 }}></div>
                                <div style={{ textAlign: 'left' }}>
                                    <h4 style={{ color: 'var(--primary-green)', fontSize: 'clamp(2rem, 6vw, 2.5rem)', margin: 0, lineHeight: 1, fontWeight: 800 }}>10+</h4>
                                    <p style={{ color: 'var(--text-muted)', fontSize: '0.85rem', fontWeight: 700, margin: '0.5rem 0 0 0', letterSpacing: '1px' }}>INSTITUTIONS</p>
                                </div>
                            </div>
                        </div>
